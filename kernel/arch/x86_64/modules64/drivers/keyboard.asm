...
.not_tab:
    ...
    add rdi, qword [r15 + CURSOR_POS_OFF]
    movzx ebx, byte [r15 + CURRENT_BG_OFF]
    mov ah, bl
    mov al, 0x20  ; space
    mov word [rdi], ax
    pop rbx
    ...
    cmp cl, 0x0E
    jne .not_bs
    cmp qword [r15 + CURSOR_POS_OFF], (13 * SCREEN_WIDTH) * 2
    jle .no_key
    sub qword [r15 + CURSOR_POS_OFF], 2
    push rax
    push rbx
    mov rdi, [r15 + DISPLAY_BASE_OFF]
    add rdi, qword [r15 + CURSOR_POS_OFF]
...
.not_bs:
    ...
    cmp cl, 0x1C
    jne .not_enter
    mov rax, qword [r15 + CURSOR_POS_OFF]
    shr eax, 1
    xor edx, edx
    push rcx
...
.enter_ok:
    mul ecx
    shl eax, 1
    mov qword [r15 + CURSOR_POS_OFF], rax
    pop rcx
    mov byte [r15 + CURSOR_VIS_OFF], 1
    ret
.not_enter:
...
.write_char:
    ...
    ; Move cursor
    add qword [r15 + CURSOR_POS_OFF], 2
    mov byte [r15 + CURSOR_VIS_OFF], 1
